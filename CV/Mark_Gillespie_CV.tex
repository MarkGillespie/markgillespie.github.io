...
%{I am currently working with Professor Mathieu Desbrun to write up the work we did together to submit for publication}
  ...
  \section{Service}
  \cvitem{Reviewer}{SIGGRAPH (2019, 2022, 2023), SIGGRAPH Asia (2022), Computer-Aided Design (2023), Transactions on Visualization and Computer Graphics (2023), Computers \& Graphics (2021)}
  \cvitem{Departmental}{Organizer, Graphics Seminar (2020-2021);
