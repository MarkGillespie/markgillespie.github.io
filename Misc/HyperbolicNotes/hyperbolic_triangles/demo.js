...
let tri_color_pair = {light: '#ffa1ce', dark: "#ff2f92"};
...
function draw_horocycle_distance_demo(control_canvas, cocircular_canvas, halfplane_canvas, distance, p1, p2, p3, p4) {
    ...
    cocircular_canvas.ctx.fillStyle = lower_h.background_color;
...
function setup() {
    ...
    *****************************************/
    ...
    let horocycle_distance = 1- horocycle_distance_slider.value / 1000;
    ...
    horocycle_distance_slider.oninput = function() {
        horocycle_distance = 1 - horocycle_distance_slider.value / 1000;
