...
\noindent{}{\bfseries #3},  \hfill {\itshape #1}
\cvindent{{#2} \hspace{.25em}\vrule width .75pt\hspace{.125em} {\itshape #6}}\\[-.5\baselineskip]
}
...
\href{https://scholar.google.com/citations?user=o_OqGM0AAAAJ}{\raisebox{-2pt}{\faGraduationCap{}} google scholar} \; $\mid$ \;
\href{https://scholar.google.com/citations?user=o_OqGM0AAAAJ}{\faGithub{} MarkGillespie}
\end{minipage}
...
\cventrywithcomment{July 2023}{Visiting Researcher}{Technische Universit\"at Berlin, Berlin}{}{}{Host: Boris Springborn}
