...
\cventry{2014--2018}{B.S. Computer Science \& B.S. Mathematics}{California Institute of Technology}{Pasadena}{}{}%Double major. GPA: 4.1}
...
\begin{enumerate}[itemsep=.25\baselineskip, leftmargin=3em, labelsep=1em]
\item[{[6]}] \cvcite{Gillespie:2024:RTH}
\item[{[5]}] \cvcite{Hirose:2024:SK}
\item[{[4]}] \cvcite{Feng:2023:WND}
\item[{[3]}] \cvcite{Liu:2023:SSI}
\item[{[2]}] \cvcite{Gillespie:2021:ICI}
\item[{[1]}] \cvcite{Gillespie:2021:DCE}
\end{enumerate}

\section{Other Refereed Publications}
\begin{enumerate}[itemsep=.25\baselineskip, leftmargin=3em, labelsep=1em]
\item[{[1]}] \cvcite{Sharp:2021:GPI}
\end{enumerate}
...
%----------------------------------
\pagebreak % TODO: might need to delete later
...
\cvitemwithcomment{2024}{Two SIGGRAPH Best Paper Award Honorable Mentions}{Awarded to 12 papers out of about 840 submissions}
