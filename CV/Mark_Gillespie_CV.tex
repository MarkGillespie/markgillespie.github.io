...
\noindent{}{\bfseries #3},  \hfill {\itshape #1}
\cvindent{{#2} \hspace{.25em}\vrule width .75pt\hspace{.125em} {\itshape #6}}\\[-.8\baselineskip]
}
...
\begin{etaremune}[itemsep=.2\baselineskip, leftmargin=2.75em, labelsep=1em]
...
\cvitemwithcomment{}{Reviewing}{SIGGRAPH (2019, 2022--2024), SIGGRAPH Asia (2022--2024), ACM Transactions on Graphics (2024), Eurographics (2024), Computer Graphics Forum (2024), Journal of Computational and Applied Mathematics (2024), Computer-Aided Design (2023), Transactions on Visualization and Computer Graphics (2023--2024), Computers \& Graphics (2021)}
