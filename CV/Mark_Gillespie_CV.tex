...
\email{mgillesp@cs.cmu.edu}                 % optional, remove / comment the line if not wanted
...
\cventry{2018--Present}{Graduate Researcher}{Carnegie Mellon University}{}
...
%{I am currently working with Professor Mathieu Desbrun to write up the work we did together to submit for publication}
  ...
  \cvitem{Reviewing}{SIGGRAPH (2019, 2022, 2023), SIGGRAPH Asia (2022, 2023), Eurographics (2024), Computer-Aided Design (2023), Transactions on Visualization and Computer Graphics (2023), Computers \& Graphics (2021)}
  \cvitem{Mentorship}{Advising Master's student (2022-2023), CMU Summer Undergraduate Research Fellowship (2020)}
