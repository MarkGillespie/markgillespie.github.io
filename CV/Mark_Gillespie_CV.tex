...
\definecolor{accent}{HTML}{005865}
...
\newcommand{\cvposition}[4]{ % {year} {title} {institution} {department}
\noindent{}{\bfseries #2} \hfill {\itshape #1}
\cvindent{{#3}\ifstrempty{#4}{}{, #4}}\\[.25\baselineskip]
}

\newcommand{\cvpositionwithcomment}[5]{ % {year} {title} {institution} {department} {comment}
\noindent{}{\bfseries #2}  \hfill {\itshape #1}
\cvindent{{#3}\ifstrempty{#4}{}{, #4} \hspace{.25em}\vrule width .75pt\hspace{.125em} {\itshape #5}}\\[.25\baselineskip]
}
...
% \vspace{-7mm}
% \includegraphics[width=\linewidth,valign=t]{logo.pdf}
% \end{minipage}
% \hspace{1mm}
...
\begin{minipage}[t][1.6cm][t]{.7\linewidth}
    \raggedleft
    \href{mailto:mark.gillespie81@gmail.com}{mark.gillespie81@gmail.com}\\
    ...
    \href{https://github.com/MarkGillespie/}{\faGithub{} github.com/MarkGillespie}
\end{minipage}}
...
\cvposition{2026--present}{Assistant Professor}{University of Utah}{Kahlert School of Computing}
\cvpositionwithcomment{2024--2026}{Postdoctoral Researcher}{École Polytechnique / INRIA Saclay}{}{working with Mathieu Desbrun} % {Sept. 2024}--June 2026

\section{Education}
\cvpositionwithcomment{2018--2024}{PhD in Computer Science}{Carnegie Mellon University}{Compter Science Department}{Advisor: Keenan Crane}\\[-1.3\baselineskip]
\cvindent{National Science Foundation Graduate Research Fellowship (NSF GRFP)}
%
\cvpositionwithcomment{2014--2018}{B.S. in Computer Science and B.S. in Mathematics}{California Institute of Technology}{}{Advisor: Peter Schröder}
...
\item \cvcite{Corman:2026:IMS}
\item \cvcite{Baktash:2026:SMT}
...
%----------------------------------
\section{Awards {\upshape \&} Honors}
%
\cvitem{2026}{University of Utah S.T.A.R. program participant}
%
\cvitemwithcomment{2026}{SIGGRAPH Best Paper Award Honorable Mention}{Awarded to 10 papers out of 922 submissions; $\sim$top 1.5\% of papers}
%
...
\shortcventry
    {May. 2025}
    {\href{https://www.geometrie.tuwien.ac.at/ig/events/dgs2026/}{Discrete Geometric Structures 2026}}
    {Implicit Minimal Surfaces for Bijective Correspondences}
    {}{}{}
%
\shortcventry
    {May. 2025}
    {\href{https://www.epfl.ch/labs/gcm/}{Geometric Computing Lab, EPFL}}
    {Implicit Minimal Surfaces for Bijective Correspondences}
    {}{}{}
%
\shortcventry
    {May. 2025}
    {\href{https://igl.ethz.ch/}{Interactive Geometry Lab, ETH Zurich}}
    {Implicit Minimal Surfaces for Bijective Correspondences}
    {}{}{}
%
\shortcventry
    {Apr. 2025}
    {\href{https://shape-analysis.github.io/}{Paris Shape Seminar, INRIA Paris}}
    {Implicit Minimal Surfaces for Bijective Correspondences}
    {}{}{}
%
\shortcventry
    {Apr. 2025}
    {\href{https://informatics.ed.ac.uk/ipab}{University of Edinburgh}} % IPAB Visitor Seminar,
    {Implicit Minimal Surfaces for Bijective Correspondences}
    {}{}{}
%
\shortcventry
    {Mar. 2025}
    {\href{https://graphics.cs.utah.edu/courses/cs7933/spring2026/}{University of Utah Graphics Seminar}}
    {Implicit Minimal Surfaces for Bijective Correspondences}
    {}{}{}
%
\shortcventry
...
\shortcventry{Fall 2026}{University of Utah}{CS 4600: Introduction to Computer Graphics}{}{}{}
%
